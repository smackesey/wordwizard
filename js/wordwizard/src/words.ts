...
function getImageUrlRoot() {
  if (process.env.NODE_ENV === 'development') {
    return 'http://images.wordwizard.smackesey.us';
  } else {
    return 'http://images.wordwizard.smackesey.us';
  }
}
...
export const WORD_LISTS: Map<string, WordListRecord[]> = new Map([
  [
    ...
    normalizeWordList({
      ...
      imageUrlRoot: 'word-images/images',
  ...
  [
    ...
    normalizeWordList({
      ...
      imageUrlRoot: 'word-images/reading-bear',
      imagePathToWordFn: (path: string) => path.replace('.png', ''),
    }),
  ],
  [
